  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/produk')?>" class="logo"><b>BDC SHOP</b></a>
            <!--logo end-->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li>
                                <a href="index.html#">
                                    <div class="task-info">
                                        <div class="desc">BDC Admin Panel</div>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="<?=base_url('index.php/produk')?>">
                  ...
                  <li class="sub-menu">
                      <a href="<?=base_url('index.php/produk/toko')?>" >
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          ...
                          <span>Pustaka Produk</span>
                      </a>
                      <ul class="sub">
                          <li><a  href="<?=base_url('index.php/produk')?>">Daftar Produk</a></li>
